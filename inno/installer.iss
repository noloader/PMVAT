; INNO installer script for Process Mutex Vulnerability Assessment Tool

#define AppVersion GetFileVersion(AddBackslash(SourcePath) + "x86\pmvat.exe")

; ==============================================================================================================

[Setup]

AppName=Process Mutex Vulnerability Assessment Tool
AppVersion={#AppVersion}
AppVerName='Process Mutex Vulnerability Assessment Tool {#AppVersion}'
...
AppComments=Test applications for Windows synchronization mutex vulnerabilities.
AppContact=http://www.softwareintegrity.com/

UsePreviousGroup=yes
UsePreviousAppDir=yes

LicenseFile=common\pmvat-license.rtf

DefaultGroupName=Software Integrity\Process Mutex Vulnerability Assessment Tool
DefaultDirName={pf}\Software Integrity\Process Mutex Vulnerability Assessment Tool

; Need admin (rather than poweruser) due to VC++ runtime. See http://www.jrsoftware.org/iskb.php?vc.
PrivilegesRequired=admin

UninstallDisplayIcon={app}\pmvat.exe
...
OutputDir=.
OutputBaseFilename="pmvat-setup"
...
VersionInfoDescription=Process Mutex Vulnerability Assessment Tool installation program.
VersionInfoProductName=Process Mutex Vulnerability Assessment Tool
...
Source: "x64\pmvat.exe"; DestDir: "{app}"; Components: program; Check: Is64BitInstallMode
...
Source: "x86\pmvat.exe"; DestDir: "{app}"; Components: program; Check: not Is64BitInstallMode
...
Source: "common\pmvat-license.rtf"; DestDir: "{app}"; Components: program;

; Source: "common\pmvat-user.pdf"; DestDir: "{app}"; Components: documentation;

; ==============================================================================================================

[Icons]

Name: "{group}\Process Mutex Vulnerability Assessment Tool"; WorkingDir: "{userdocs}"; Comment: "Securely store documents and files using password based cryptography and authenticated encryption."; Filename: "{app}\pmvat.exe"
Name: "{group}\User Guide"; Comment: "Read the user guide."; Filename: "{app}\pmvat-user.pdf"

Name: "{commonprograms}\Process Mutex Vulnerability Assessment Tool"; Comment: "Test applications for Windows synchronization mutex vulnerabilities."; WorkingDir: "{userdocs}"; Filename: "{app}\pmvat.exe"
Name: "{commondesktop}\Process Mutex Vulnerability Assessment Tool"; Comment: "Test applications for Windows synchronization mutex vulnerabilities."; WorkingDir: "{userdocs}"; Filename: "{app}\pmvat.exe"
